...
struct Z_Construct_UClass_UHealthAttributeSet_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_DefaultMaxHealth_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Health" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/* Determines the default maximum health to use for this health type */" },
#endif
		{ "ModuleRelativePath", "Public/HealthAttributeSet.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Determines the default maximum health to use for this health type" },
#endif
	};
#endif // WITH_METADATA
...
// ********** Begin Class UHealthAttributeSet constinit property declarations **********************
	...
	static const UECodeGen_Private::FFloatPropertyParams NewProp_DefaultMaxHealth;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UHealthAttributeSet_Statics::NewProp_DefaultMaxHealth = { "DefaultMaxHealth", nullptr, (EPropertyFlags)0x0040000000010015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UHealthAttributeSet, DefaultMaxHealth), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DefaultMaxHealth_MetaData), NewProp_DefaultMaxHealth_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UHealthAttributeSet_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UHealthAttributeSet_Statics::NewProp_DefaultMaxHealth,
};
...
struct Z_CompiledInDeferFile_FID_Github_Simulation_Simulation_Source_Simulation_Public_HealthAttributeSet_h__Script_Simulation_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UHealthAttributeSet, UHealthAttributeSet::StaticClass, TEXT("UHealthAttributeSet"), &Z_Registration_Info_UClass_UHealthAttributeSet, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHealthAttributeSet), 582141908U) },
	};
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Github_Simulation_Simulation_Source_Simulation_Public_HealthAttributeSet_h__Script_Simulation_1647654116{
